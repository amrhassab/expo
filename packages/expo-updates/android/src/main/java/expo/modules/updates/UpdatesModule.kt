...
class UpdatesModule : Module() {
  ...
  override fun definition() = ModuleDefinition {
      ...
      UpdatesController.instance.relaunchReactApplicationForModule(
        ...
        object : IUpdatesController.ModuleCallback<Unit> {
          ...
          override fun onFailure(exception: CodedException) {
            Log.e(TAG, "Failed to relaunch application", exception)
    ...
    AsyncFunction("checkForUpdateAsync") { promise: Promise ->
      UpdatesController.instance.checkForUpdate(context, object : IUpdatesController.ModuleCallback<CheckForUpdateResult> {
    ...
    AsyncFunction("fetchUpdateAsync") { promise: Promise ->
      UpdatesController.instance.fetchUpdate(context, object : IUpdatesController.ModuleCallback<FetchUpdateResult> {
    ...
    AsyncFunction("setExtraParamAsync") { key: String, value: String?, promise: Promise ->
      ...
      UpdatesController.instance.setExtraParam(key, value, object : IUpdatesController.ModuleCallback<Unit> {
        override fun onSuccess(result: Unit) {
          promise.resolve(null)
        }
